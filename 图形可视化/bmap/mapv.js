(function (global, factory) {
    ...
    var drawGrid = {
        draw: function draw(context, dataSet, options) {
            ...
            // 鍚庣浼犲叆鏁版嵁涓虹綉鏍兼暟鎹椂锛屼紶鍏nableCluster涓篺alse锛屽墠绔笉杩涜鍒犳牸鍖栨搷浣滐紝鐩存帴鐢绘柟鏍�
    ...
    var AnimationLayer = function (_BaseLayer) {
        ...
        createClass(AnimationLayer, [{
            ...
            value: function _canvasUpdate() {
                ...
                var nwMc = new BMap$2.Pixel(mcCenter.x - map.getSize().width / 2 * zoomUnit, mcCenter.y + map.getSize().height / 2 * zoomUnit); //宸︿笂瑙掑ⅷ鍗℃墭鍧愭爣
    ...
    var Layer = function (_BaseLayer) {
        ...
        createClass(Layer, [{
            ...
            value: function _canvasUpdate(time) {
                ...
                var nwMc = new BMap$3.Pixel(mcCenter.x - map.getSize().width / 2 * zoomUnit, mcCenter.y + map.getSize().height / 2 * zoomUnit); //宸︿笂瑙掑ⅷ鍗℃墭鍧愭爣
        ...
        createClass(Layer, [{
            ...
            value: function render(canvas, time) {
                ...
                dataGetOptions.transferCoordinate = _projection === mapViewProjection ? function (coordinate) {
                    // 褰撴暟鎹笌map鐨勬姇褰变竴鑷存椂涓嶅啀杩涜鎶曞奖杞崲
                    return map.getPixelFromCoordinate(coordinate);
                } : function (coordinate) {
                    // 鏁版嵁涓嶮ap鎶曞奖涓嶄竴鑷存椂 灏嗘暟鎹姇褰辫浆鎹负 Map鐨勬姇褰�
                ...
                if (!this.canvasLayer.canvas && !this.layer_) {
                    ...
                    this.layer_ = new ol.layer.Image({
                        ...
                        source: new ol.source.ImageCanvas({
                            ...
                            projection: this.$Map.getView().getProjection().getCode(), // 鍥惧眰鎶曞奖涓嶮ap淇濇寔涓€鑷�
...
// https://github.com/SuperMap/iClient-JavaScript
     ...
     * @param {L.Map} map - 寰呮覆鏌撶殑鍦板浘銆�
     * @param {L.Layer} layer - 寰呮覆鏌撶殑鍥惧眰銆�
     * @param {DataSet} dataSet - 寰呮覆鏌撶殑鏁版嵁闆嗐€�
     * @param {Object} options - 娓叉煋鐨勫弬鏁般€�
     */
    var MapVRenderer = function (_BaseLayer) {
        ...
        createClass(MapVRenderer, [{
             ...
             * @description 缁戝畾榧犳爣绉诲姩鍜岄紶鏍囩偣鍑讳簨浠躲€�
             * @param {Object} e - 瑙﹀彂瀵硅薄銆�
             */
             ...
             * @description 瑙ｇ粦榧犳爣绉诲姩鍜岄紶鏍囨粦鍔ㄨЕ鍙戠殑浜嬩欢銆�
             * @param {Object} e - 瑙﹀彂瀵硅薄銆�
             */
             ...
             * @description 娣诲姞鏁版嵁銆�
             * @param {Object} data - 寰呮坊鍔犵殑鏁版嵁銆�
             * @param  {Object} options - 寰呮坊鍔犵殑鏁版嵁淇℃伅銆�
             */
             ...
             * @description 鏇存柊鍥惧眰銆�
             * @param {Object} opt - 寰呮洿鏂扮殑鏁版嵁銆�
             * @param {Object} opt.data - mapv鏁版嵁闆嗐€�
             * @param {Object} opt.options - mapv缁樺埗鍙傛暟銆�
             */
             ...
             * @description 鍒犻櫎绗﹀悎杩囨护鏉′欢鐨勬暟鎹€�
             * @param {Function} filter - 杩囨护鏉′欢銆傛潯浠跺弬鏁颁负鏁版嵁椤癸紝杩斿洖鍊间负 true锛岃〃绀哄垹闄よ鍏冪礌锛涘惁鍒欒〃绀轰笉鍒犻櫎銆�
             */
            ...
            value: function _canvasUpdate(time) {
                ...
                //鑾峰彇灞忓箷宸︿笂瑙掔殑鍦扮悊鍧愭爣鍧愭爣
                //宸︿笂瑙掑睆骞曞潗鏍囦负0,0
                var topLeft = this.canvasLayer.getTopLeft();

                var topLeftPX = map.latLngToContainerPoint(topLeft);
                // 鑾峰彇绮剧‘鐨勫儚绱犲潗鏍�. https://github.com/SuperMap/iClient-JavaScript/blob/eacc26952b8915bba0122db751d766056c5fb24d/src/leaflet/core/Base.js
             ...
             * @description 娓呴櫎淇℃伅銆�
             * @param {string} context - 鎸囧畾瑕佹竻闄ょ殑淇℃伅銆�
             */
    ...
    if (typeof L !== 'undefined') {
         ...
         * @category Visualization MapV
         * @extends {L.Layer}
         * @param {mapv.DataSet} dataSet - MapV 鍥惧眰鏁版嵁闆嗐€�
         * @param {Object} mapVOptions - MapV 鍥惧眰鍙傛暟銆�
         * @param {Object} options - 鍙傛暟銆�
         * @param {string} [options.attributionPrefix] - 鐗堟潈淇℃伅鍓嶇紑銆�
         * @param {string} [options.attribution='漏 2018 鐧惧害 MapV'] - 鐗堟潈淇℃伅銆�
        ...
        var MapVLayer = L.Layer.extend({
             ...
             * @description 娣诲姞鍦板浘鍥惧眰銆�
             * @param {L.Map} map - 瑕佹坊鍔犵殑鍦板浘銆�
             */
             ...
             * @description 杩藉姞鏁版嵁銆�
             * @param {Object} data - 瑕佽拷鍔犵殑鏁版嵁銆�
             * @param {Object} options - 瑕佽拷鍔犵殑鍊笺€�
             */
             ...
             * @description 鏇存柊鍥惧眰銆�
             * @param {Object} opt - 寰呮洿鏂扮殑鏁版嵁銆�
             * @param {Object} data - mapv 鏁版嵁闆嗐€�
             * @param {Object} options - mapv 缁樺埗鍙傛暟銆�
             */
             ...
             * @description 鑾峰彇鏁版嵁銆�
             * @returns {mapv.DataSet} mapv 鏁版嵁闆嗐€�
             */
             ...
             * @description 璁剧疆 canvas 灞傜骇銆�
             * @param {number} zIndex - canvas 灞傜骇銆�
             */
             ...
             * @description 鑾峰彇 canvas銆�
             * @returns {HTMLElement} 杩斿洖 mapV 鍥惧眰鍖呭惈鐨� canvas 瀵硅薄銆�
             */
             ...
             * @description 鑾峰彇瀹瑰櫒銆�
             * @returns {HTMLElement} 杩斿洖鍖呭惈 mapV 鍥惧眰鐨� dom 瀵硅薄銆�
             */
             ...
             * @description 鑾峰彇宸︿笂瑙掑潗鏍囥€�
             * @returns {L.Bounds} 杩斿洖宸︿笂瑙掑潗鏍囥€�
             */
